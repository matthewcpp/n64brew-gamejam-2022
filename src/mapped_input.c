...
void mapped_input_set_map_layout(InputMapping* mapping, InputMapLayout layout) {
	...
	mapping->buttons[INPUT_MAP_WEAPON_RELOAD 	- INPUT_MAP_START] = FW64_N64_CONTROLLER_BUTTON_L | FW64_N64_CONTROLLER_BUTTON_R;
	...
	switch(layout) {
		case INPUT_MAP_LAYOUT_PERFECTEYE:
			...
			mapping->buttons[INPUT_MAP_MOVE_LEFT 		- INPUT_MAP_START] = FW64_N64_CONTROLLER_BUTTON_DPAD_LEFT  | FW64_N64_CONTROLLER_BUTTON_C_LEFT;
			mapping->buttons[INPUT_MAP_MOVE_RIGHT 		- INPUT_MAP_START] = FW64_N64_CONTROLLER_BUTTON_DPAD_RIGHT | FW64_N64_CONTROLLER_BUTTON_C_RIGHT;
			mapping->buttons[INPUT_MAP_LOOK_UP 			- INPUT_MAP_START] = FW64_N64_CONTROLLER_BUTTON_DPAD_UP    | FW64_N64_CONTROLLER_BUTTON_C_UP;
			mapping->buttons[INPUT_MAP_LOOK_DOWN 		- INPUT_MAP_START] = FW64_N64_CONTROLLER_BUTTON_DPAD_DOWN  | FW64_N64_CONTROLLER_BUTTON_C_DOWN;
		...
		case INPUT_MAP_LAYOUT_MODERN_TWINSTICK:
			...
			mapping->buttons[INPUT_MAP_LOOK_UP 			- INPUT_MAP_START] = FW64_N64_CONTROLLER_BUTTON_DPAD_UP    | FW64_N64_CONTROLLER_BUTTON_C_UP;
			mapping->buttons[INPUT_MAP_LOOK_DOWN 		- INPUT_MAP_START] = FW64_N64_CONTROLLER_BUTTON_DPAD_DOWN  | FW64_N64_CONTROLLER_BUTTON_C_DOWN;
			mapping->buttons[INPUT_MAP_LOOK_LEFT 		- INPUT_MAP_START] = FW64_N64_CONTROLLER_BUTTON_DPAD_LEFT  | FW64_N64_CONTROLLER_BUTTON_C_LEFT;
			mapping->buttons[INPUT_MAP_LOOK_RIGHT 		- INPUT_MAP_START] = FW64_N64_CONTROLLER_BUTTON_DPAD_RIGHT | FW64_N64_CONTROLLER_BUTTON_C_RIGHT;
			break;
		case INPUT_MAP_LAYOUT_MODERN_TWINSTICK_SWAPPED:
			...
			mapping->buttons[INPUT_MAP_LOOK_LEFT 		- INPUT_MAP_START] = INPUT_MAP_VSTICK_ANALOG_X_NEG;
			mapping->buttons[INPUT_MAP_LOOK_RIGHT 		- INPUT_MAP_START] = INPUT_MAP_VSTICK_ANALOG_X_POS;
			mapping->buttons[INPUT_MAP_MOVE_FORWARD 	- INPUT_MAP_START] = FW64_N64_CONTROLLER_BUTTON_DPAD_UP    | FW64_N64_CONTROLLER_BUTTON_C_UP;
			mapping->buttons[INPUT_MAP_MOVE_BACKWARD	- INPUT_MAP_START] = FW64_N64_CONTROLLER_BUTTON_DPAD_DOWN  | FW64_N64_CONTROLLER_BUTTON_C_DOWN;
			mapping->buttons[INPUT_MAP_MOVE_LEFT 		- INPUT_MAP_START] = FW64_N64_CONTROLLER_BUTTON_DPAD_LEFT  | FW64_N64_CONTROLLER_BUTTON_C_LEFT;
			mapping->buttons[INPUT_MAP_MOVE_RIGHT 		- INPUT_MAP_START] = FW64_N64_CONTROLLER_BUTTON_DPAD_RIGHT | FW64_N64_CONTROLLER_BUTTON_C_RIGHT;
			break;
		default: 
